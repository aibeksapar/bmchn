...
class SelectConstructor {
	...
	optionAction(selectItem, originalSelect, optionItem) {
		if (originalSelect.multiple) { // Если мультивыбор
			...
			document.querySelectorAll('.select__option').forEach((el) => {
				el.classList.remove('_select-selected');
			})

			optionItem.classList.add('_select-selected');
	...
	selectChange(e) {
		console.log(classSelectOptions);
		// classSelectOption.classList.remove('_select-selected');
